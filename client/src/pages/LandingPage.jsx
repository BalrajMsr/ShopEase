      ...
      <header className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'glass shadow-lg' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <img className="w-[80px] h-[80px] md:w-[60px] md:h-[60px]" src="shop_ease_logo.png" alt="shop ease logo" />
            <h1 className="hidden md:block text-3xl font-bold gradient-text">ShopEase</h1>
          </div>
